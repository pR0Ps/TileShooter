...
function Awake () {
	//Set current position to by "maxHeight" units above the target, offset backwards by "horizontalDistance"
	transform.position = target.position + Vector3.up * maxHeight - Vector3.forward * horizontalDistance;
